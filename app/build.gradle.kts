...
dependencies {
    ...
    // Amplify plugins
    implementation(AmplifyLibs.CORE)
    implementation(AmplifyLibs.AWS_API)
    implementation(AmplifyLibs.AWS_DATASTORE)

    // Support for Java 8 features
    coreLibraryDesugaring(AmplifyLibs.JAVA_8_FEATURES_SUPPORT)
}